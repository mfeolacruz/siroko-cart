...
final class OrderIdTest extends TestCase
{
    ...
    public function testItThrowsExceptionForInvalidUuid(): void
    {
        ...
        $this->expectExceptionMessage('<App\Domain\Checkout\ValueObject\OrderId> does not allow the value <invalid-uuid>.');
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('<App\Domain\Checkout\ValueObject\OrderId> does not allow the value <>.');
